...
class Ui_mainWidget(object):
    def setupUi(self, mainWidget):
        ...
        self.gridLayout_2.addWidget(self.obj_output_groupBox, 2, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.obj_preview_groupBox, 0, 0, 1, 2)
        ...
        sizePolicy.setHeightForWidth(self.obj_ocr_pushButton.sizePolicy().hasHeightForWidth())
        self.obj_ocr_pushButton.setSizePolicy(sizePolicy)
        self.obj_ocr_pushButton.setMinimumSize(QSize(24, 0))

        self.gridLayout_2.addWidget(self.obj_ocr_pushButton, 6, 1, 1, 1)
        ...
        sizePolicy1.setHeightForWidth(self.obj_open_pushButton.sizePolicy().hasHeightForWidth())
        self.obj_open_pushButton.setSizePolicy(sizePolicy1)
        self.obj_open_pushButton.setMinimumSize(QSize(24, 0))
        self.obj_open_pushButton.setMaximumSize(QSize(16777215, 16777215))

        self.gridLayout_2.addWidget(self.obj_open_pushButton, 5, 1, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.obj_result_groupBox.sizePolicy().hasHeightForWidth())
        self.obj_result_groupBox.setSizePolicy(sizePolicy2)
        ...
        self.obj_rssult_scrollAreaWidgetContents.setGeometry(QRect(0, 0, 699, 69))
    ...
    def retranslateUi(self, mainWidget):
        mainWidget.setWindowTitle(QCoreApplication.translate("mainWidget", u"\u5355\u53e5OCR\u8bc6\u522b", None))
        self.obj_output_groupBox.setTitle(QCoreApplication.translate("mainWidget", u"\u5206\u5272", None))
